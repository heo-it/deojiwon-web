    ...
    <section className="w-full bg-white text-gray-800">
      <div className="max-w-screen-xl mx-auto px-4 py-10">
        ...
        <div className="relative rounded-lg overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
            <p className="text-white text-xl md:text-3xl font-semibold text-center px-4 leading-relaxed">
              ...
              정보통신 유지보수를 <br className="md:hidden" />
              선도합니다.
            </p>
          </div>
        </div>
        ...
        <div className="pt-4 pb-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 md:gap-12 mt-10 text-center text-sm sm:text-base font-medium ">
            {[
              "유지보수 관리자 선임",
              "장애처리 / 예방정비",
              "성능개선 / 증설",
              ...
              <div
                key={i}
                className="py-3 px-2 rounded shadow-sm border border-slate-400"
              >
                {item}
              </div>
            ))}
